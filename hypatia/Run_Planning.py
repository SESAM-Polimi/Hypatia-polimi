...
Utopia = Model(
    path="examples/Planning_2Regions/sets",                             # Path to the sets folder
...
Utopia.read_input_data("examples/Planning_2Regions/parameters")         # Path to the parameters folder
...
if OptimizationMode == "Multi":    
    Utopia.run_MO(
        ...
        path = "examples/Planning_2Regions/Pareto Froniter",                 # Path to the destination folder where all the results of the solutions are saved
        verbosity=True,
        force_rewrite= True                                                 # Overwrite the parameters files (True) or not (False)
    )
...
if not os.path.exists("examples/Planning_2Regions/results"):
    os.mkdir("examples/Planning_2Regions/results")
    
#%%
# Save the results as csv file in the previous folder

Utopia.to_csv(
    path= "examples/Planning_2Regions/results",                         # Path to the destination folder for the results
    force_rewrite=True,                                                 # Overwrite the parameters files (True) or not (False)
...
#     path = 'examples/Planning_2Regions/config.xlsx'                     # Path to the config file
# )
...
if not os.path.exists("examples/Planning_2Regions/plots"):
    os.mkdir("examples/Planning_2Regions/plots")
...
plots = Plotter(
    ...
    config = 'examples/Planning_2Regions/config.xlsx',                  # Path to the config file
...
plots.plot_total_capacity(
    path = "examples/Planning_2Regions/plots/totalcapacity.html",       # Path to the folder in which the plot will be saved
...
plots.plot_new_capacity(
    path = "examples/Planning_2Regions/plots/newcapacity.html",         # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    kind="bar",                                                         # "Bar" or "Area" are the two kind of plots accepted
...
plots.plot_prod_by_tech(
    path = "examples/Planning_2Regions/plots/prod_by_tech.html",        # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    kind="bar",                                                         # "Bar" or "Area" are the two kind of plots accepted
    regions="all",                                                      # The regions considered. "all" to consider all of them, ["reg1", ...] to consider only some regions
    aggregate=False                                                     # True to aggregate the results of each region, False to plot them separately
...
plots.plot_use_by_technology(
    path = "examples/Planning_2Regions/plots/use_by_tech.html",         # Path to the folder in which the plot will be saved
...
plots.plot_fuel_prod_cons(
    path = "examples/Planning_2Regions/plots/prod_con_share_2020.html",     # Path to the folder in which the plot will be saved
...
plots.plot_fuel_prod_cons(
    path = "examples/Planning_2Regions/plots/prod_con_share_2030.html",     # Path to the folder in which the plot will be saved
...
plots.plot_emissions(
    path = "examples/Planning_2Regions/plots/emissions.html",           # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
...
plots.plot_hourly_prod_by_tech(
    path = "examples/Planning_2Regions/plots/hourlyprod_2020.html",     # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    fuel_group = 'Electricity',                                         # The group of the carriers, reported in the configuration file, to be plotted
    kind = "bar",                                                       # "Bar" or "Area" are the two kind of plots accepted
...
plots.plot_hourly_prod_by_tech(
    path = "examples/Planning_2Regions/plots/hourlyprod_2030.html",     # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    fuel_group = 'Electricity',                                         # The group of the carriers, reported in the configuration file, to be plotted
    kind = "bar",                                                       # "Bar" or "Area" are the two kind of plots accepted
...
plots.plot_regional_costs(
    path = "examples/Planning_2Regions/plots/regionalcost_by_tech.html", # Path to the folder in which the plot will be saved
