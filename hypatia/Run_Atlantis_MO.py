...
Atlantis = Model(
    path="examples/Atlantis/sets",                             # Path to the sets folder
...
# Atlantis.create_data_excels(
#     path ='examples/Atlantis/parameters_empty',                      # Path to the parameters folder
...
Atlantis.read_input_data("examples/Atlantis/parameters")         # Path to the parameters folder
...
if OptimizationMode == "Multi":    
    Atlantis.run_MO(
        ...
        path = "examples/Atlantis/Pareto Froniter",                 # Path to the destination folder where all the results of the solutions are saved
        verbosity=True,
        force_rewrite= True                                                 # Overwrite the parameters files (True) or not (False)
    )
...
if not os.path.exists("examples/Atlantis/results"):
    os.mkdir("examples/Atlantis/results")
    
#%%
# Save the results as csv file in the previous folder

Atlantis.to_csv(
    path= "examples/Atlantis/results",                         # Path to the destination folder for the results
    force_rewrite=True,                                                 # Overwrite the parameters files (True) or not (False)
...
# Atlantis.create_config_file(
#     path = 'examples/Atlantis/config.xlsx'                     # Path to the config file
# )
...
if not os.path.exists("examples/Atlantis/plots"):
    os.mkdir("examples/Atlantis/plots")
    
#%% 
# Read the configuration file

plots = Plotter(
    results = Atlantis,                                                   # Name of the Model
    config = 'examples/Atlantis/config.xlsx',                  # Path to the config file
...
plots.plot_total_capacity(
    path = "examples/Atlantis/plots/totalcapacity.html",       # Path to the folder in which the plot will be saved
...
plots.plot_new_capacity(
    path = "examples/Atlantis/plots/newcapacity.html",         # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    kind="bar",                                                         # "Bar" or "Area" are the two kind of plots accepted
...
plots.plot_prod_by_tech(
    path = "examples/Atlantis/plots/prod_by_tech.html",        # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    kind="bar",                                                         # "Bar" or "Area" are the two kind of plots accepted
    regions="all",                                                      # The regions considered. "all" to consider all of them, ["reg1", ...] to consider only some regions
    aggregate=False                                                     # True to aggregate the results of each region, False to plot them separately
...
plots.plot_use_by_technology(
    path = "examples/Atlantis/plots/use_by_tech.html",         # Path to the folder in which the plot will be saved
...
plots.plot_fuel_prod_cons(
    path = "examples/Atlantis/plots/prod_con_share_2020.html",     # Path to the folder in which the plot will be saved
...
plots.plot_fuel_prod_cons(
    path = "examples/Atlantis/plots/prod_con_share_2030.html",     # Path to the folder in which the plot will be saved
...
plots.plot_emissions(
    path = "examples/Atlantis/plots/emissions.html",           # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
...
plots.plot_hourly_prod_by_tech(
    path = "examples/Atlantis/plots/hourlyprod_2020.html",     # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    fuel_group = 'Electricity',                                         # The group of the carriers, reported in the configuration file, to be plotted
    kind = "bar",                                                       # "Bar" or "Area" are the two kind of plots accepted
...
plots.plot_hourly_prod_by_tech(
    path = "examples/Atlantis/plots/hourlyprod_2030.html",     # Path to the folder in which the plot will be saved
    tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    fuel_group = 'Electricity',                                         # The group of the carriers, reported in the configuration file, to be plotted
    kind = "bar",                                                       # "Bar" or "Area" are the two kind of plots accepted
...
plots.plot_regional_costs(
    path = "examples/Atlantis/plots/regionalcost_by_tech.html", # Path to the folder in which the plot will be saved
