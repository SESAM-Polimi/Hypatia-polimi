...
class BuildModel:
    ...
    def __init__(self, model_data: ModelData):
        ...
        # For Optimization, multiregions, activate the emission objective for each region and for whole
        ...
        # For Planning you set regional planning, if not multi, you have single node, else you have lines planning and multinode
        ...
        ## For creation of the multi objective optimization - Gianluca's edit        
