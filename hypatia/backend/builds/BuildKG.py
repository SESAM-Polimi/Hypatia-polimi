...
class BuildModel:
    ...
    def _solve_MO(self, number_solutions, path, verbosity, solver, **kwargs):
        ...
        emission_list = [Max_emissions] + emission_list[0:number_solutions] + [Min_emissions]
        NPC_list = [Min_NPC] + NPC_list[0:number_solutions] + [Max_NPC]
